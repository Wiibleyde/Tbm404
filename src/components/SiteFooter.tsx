  ...
  return (
    <footer className="border-t border-paper-2">
      <div className="mx-auto flex max-w-5xl flex-col gap-4 px-4 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        ...
        <nav className="flex items-center gap-4 font-mono text-xs text-ink/50">
          ...
          <a
            href="https://github.com/Wiibleyde/Tbm404"
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 transition-colors hover:text-ink"
          >
            <svg viewBox="0 0 16 16" className="h-4 w-4 fill-current" role="img">
              <title>GitHub</title>
